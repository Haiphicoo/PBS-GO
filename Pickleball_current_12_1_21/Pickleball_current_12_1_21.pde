...
void draw() {
  ...
  case 1:
    ...
    //pickler.display(p5.x, p5.y);
    p5.render();
    p5.moveLeft();
    p5.moveRight();
    p5.scoring(b1);

    redPickler.display(p5.x, p5.y);
    a1.render();
    a1.ease(b1);
    a1.hit(b1);
    a1.scoring(b1);
  ...
  case 2:
    ...
    pickler.display(p1.x, p1.y);
    p1.render();
    p1.moveLeft1();
    p1.moveRight1();
    p1.scoring(b2);

    greenPickler.display(p2.x, p2.y);
    p2.render();
    p2.moveLeft1();
    p2.moveRight1();
    p2.scoring(b2); 

    pickler.display(p3.x, p3.y);
    p3.render();
    p3.moveLeft2();
    p3.moveRight2();
    p3.scoring(b3);

    greenPickler.display(p4.x, p4.y);
    p4.render();
    p4.moveLeft2();
    p4.moveRight2();
    p4.scoring(b3);
